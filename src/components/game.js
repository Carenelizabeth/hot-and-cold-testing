...
export class Game extends React.Component {
  ...
  makeGuess(guess) {
    ...
    if (isNaN(guess)) {
      this.props.dispatch(actions.giveFeedback('Please enter a valid number'));
      return;
    }
    ...
    this.props.dispatch(actions.giveFeedback(feedback));
  ...
  generateAuralUpdate() {
    ...
    this.props.dispatch(actions.updateAuralStatus(auralStatus));
  }
